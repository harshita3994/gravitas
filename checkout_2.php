		...
		<div id="header"><img id="header"  src="img/gravitas_logo.png" width="250px" height="100px"/></div>
			...
			<div id="formdiv_inner">
					<table border="1">
						...
						<?php
						$query="SELECT * FROM bill_combo WHERE receipt_no = '$_SESSION[id]'";
							$ans = mysql_query($query) OR die("Session of ID issue");
							while($res=mysql_fetch_assoc($ans))
							{
								echo "<tr><td >".$res['receipt_no']."</td>";
								echo "<td >".$res['name']."</td>";
								echo "<td >".$res['registration']."</td>";	
								echo "<td >".$res['contact_no']."</td>";	
								echo "<td >".$res['event1'].",".$res['event2'].",".$res['event3']."</td>";
								echo "<td>".$res['seat1']."+".$res['seat2']."+".$res['seat3']."</td>";
								echo "<td >".$res['amount']."</td></tr>";
							}
							$temp_time = time() + 12600; // The timestamp...
							$curr_time = date("H:i:s",$temp_time);
							$query = "UPDATE bill_combo SET username='$_SESSION[user]',time='$curr_time' WHERE receipt_no='$_SESSION[id]'";
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a id="red" href="process/delete_2.php?id=<?php echo $_SESSION['id']; ?>">DELETE</a>
			</div>
			</div>	
     </div>
	</div>
